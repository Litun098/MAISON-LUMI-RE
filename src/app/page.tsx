    ...
    <>
      ...
      <section className="relative flex min-h-[88vh] items-center overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6">
          <div className="max-w-2xl fade-up">
            <p className="eyebrow !text-paper/60">The Winter Collection — 1924</p>
      ...
      <section className="grid md:grid-cols-2">
        ...
        >
          <span
            aria-hidden
            className="font-serif absolute bottom-8 left-8 text-7xl text-paper/10"
          >
            Atelier
          </span>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3">
          {[
            { c: "Outerwear", from: "#2c2a26", to: "#4a463f" },
            { c: "Tailoring", from: "#1f2933", to: "#3c4a57" },
            { c: "Knitwear", from: "#43352a", to: "#5f4c3c" },
          ].map((cat) => (
            <Link
              key={cat.c}
              href={`/shop?c=${cat.c}`}
            ...
            >
              <div className="relative z-10">
                <h3 className="font-serif text-2xl text-paper">{cat.c}</h3>
                <span className="eyebrow !text-paper/70">Discover →</span>
              </div>
